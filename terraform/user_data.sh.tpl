...
sed -i 's/KAFKA_NODE_ID: 1/KAFKA_NODE_ID: ${broker_id}/' ./thesis/docker/docker-compose.yaml
sed -i "s/kafka1/$BROKER1_IP/" /home/ubuntu/thesis/docker/broker.yaml
sed -i "s/kafka2/$BROKER2_IP/" /home/ubuntu/thesis/docker/broker.yaml
sed -i "s/kafka3/$BROKER3_IP/" /home/ubuntu/thesis/docker/broker.yaml
