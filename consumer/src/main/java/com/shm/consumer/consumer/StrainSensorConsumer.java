...
//    System.out.println("sg-consumer 18: "+ record.key() + "\n Value: "+ record.value());
  ...
  public void consumer19(ConsumerRecord<String, String> record){
//    System.out.println("sg-consumer 18: "+ record.key() + "\n Value: "+ record.value());
    sensorDataService.storeDataToDb(record.value());
  }
  ...
  public void consumer20(ConsumerRecord<String, String> record){
//    System.out.println("sg-consumer 18: "+ record.key() + "\n Value: "+ record.value());
    sensorDataService.storeDataToDb(record.value());
  }
  ...
  public void consumer21(ConsumerRecord<String, String> record){
//    System.out.println("sg-consumer 18: "+ record.key() + "\n Value: "+ record.value());
    sensorDataService.storeDataToDb(record.value());
  }
  ...
  public void consumer22(ConsumerRecord<String, String> record){
//    System.out.println("sg-consumer 18: "+ record.key() + "\n Value: "+ record.value());
    sensorDataService.storeDataToDb(record.value());
  }
  ...
  public void consumer23(ConsumerRecord<String, String> record){
//    System.out.println("sg-consumer 18: "+ record.key() + "\n Value: "+ record.value());
    sensorDataService.storeDataToDb(record.value());
  }
  ...
  public void consumer24(ConsumerRecord<String, String> record){
//    System.out.println("sg-consumer 18: "+ record.key() + "\n Value: "+ record.value());
    sensorDataService.storeDataToDb(record.value());
  }
  ...
  public void consumer25(ConsumerRecord<String, String> record){
//    System.out.println("sg-consumer 18: "+ record.key() + "\n Value: "+ record.value());
    sensorDataService.storeDataToDb(record.value());
  }
  ...
  public void consumer26(ConsumerRecord<String, String> record){
//    System.out.println("sg-consumer 18: "+ record.key() + "\n Value: "+ record.value());
    sensorDataService.storeDataToDb(record.value());
  }
  ...
  public void consumer27(ConsumerRecord<String, String> record){
//    System.out.println("sg-consumer 18: "+ record.key() + "\n Value: "+ record.value());
    sensorDataService.storeDataToDb(record.value());
  }
  @KafkaListener(
      id = "sg-consumer28",topics = "sg-data", groupId = "sg-data-group")
  public void consumer28(ConsumerRecord<String, String> record){
//    System.out.println("sg-consumer 18: "+ record.key() + "\n Value: "+ record.value());
    sensorDataService.storeDataToDb(record.value());
  }
}
